...
extension NSObject {
    ...
    func addProperty(name: String, value: AnyObject?) {
        ...
        let propertyType: String = value.classForCoder != nil ? NSStringFromClass(value.classForCoder!) : value.description
        
        let type = objc_property_attribute_t(name: ("T" as NSString).utf8String!,
                                             value: (("\"" + propertyType + "\"") as NSString).utf8String!)
